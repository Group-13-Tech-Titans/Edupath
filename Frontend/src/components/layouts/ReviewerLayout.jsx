...
const navItems = [
  { to: "/reviewer", label: "Home", end: true },
  { to: "/reviewer/history", label: "History" },
  { to: "/reviewer/pathways", label: "Pathways" },
];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <header className="sticky top-0 z-30 border-b border-black/5 bg-white/60 backdrop-blur">
        <div className="mx-auto max-w-6xl px-4 py-3">
          <div className="flex items-center justify-between gap-3">
            <Link to="/reviewer" className="flex shrink-0 items-center gap-2">
              ...
              <div className="leading-tight">
                ...
                <p className="text-[11px] text-muted -mt-0.5">Reviewer</p>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-3">
              <button
                onClick={() => navigate("/reviewer?profile=1")}
      ...
      <footer className="mx-auto mt-10 w-full max-w-6xl px-4 pb-6">
        <DashboardFooter
          panelLabel="Reviewer Panel"
          description="Review course submissions, manage feedback history, and help keep EduPath course quality consistent."
          sections={[
            {
              title: "Reviewer",
              items: [
                ...
                { label: "Review History", to: "/reviewer/history" },
                { label: "Pathways", to: "/reviewer/pathways" },
              ],
            },
            {
              title: "Help & Policy",
              items: [
                { label: "Reviewer Help Center", to: "/reviewer/help" },
                { label: "Contact Support", to: "/reviewer/contact" },
