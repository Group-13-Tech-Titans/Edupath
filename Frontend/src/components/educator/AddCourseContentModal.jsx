...
export default function AddCourseContentModal({ isOpen, onClose, onAddContent, initialData = null }) {
    const [activeTab, setActiveTab] = useState("pdf");

    /* ---------------- VIDEO + PDF DESCRIPTION STATE ---------------- */
    const [videoDescription, setVideoDescription] = useState(initialData?.description || "");
    const [pdfDescription, setPdfDescription] = useState(initialData?.description || "");
    ...
    const [quizzes, setQuizzes] = useState(
        Array.isArray(initialData?.quizzes) && initialData.quizzes.length > 0
            ? initialData.quizzes
            : [
                {
                    question: "",
    ...
    useEffect(() => {
        ...
        setActiveTab(initialData.type || "pdf");
        setTitle(initialData.title || "");
        setSection(initialData.section || "");
        setVideoDescription(initialData.type === "video" ? (initialData.description || "") : "");
        setPdfDescription(initialData.type === "pdf" ? (initialData.description || "") : "");
        setQuizzes(
            Array.isArray(initialData.quizzes) && initialData.quizzes.length > 0
                ? initialData.quizzes
                : [
