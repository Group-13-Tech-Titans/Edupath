          ...
          <div className="mb-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex items-center gap-3 rounded-3xl bg-white/70 px-4 py-3 shadow backdrop-blur">
              ...
              <div className="leading-tight">
                ...
                <p className={`mt-1 text-[10px] font-black uppercase tracking-wider ${isPremium ? "text-emerald-600" : "text-slate-400"}`}>
            ...
            <form onSubmit={handleSave} className="space-y-7">
              ...
              <section className="rounded-3xl border border-black/5 bg-white/60 p-5">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                  ...
                  <a
                    href="/student/plans"
                    className="self-start sm:self-auto bg-slate-900 hover:bg-slate-800 text-white text-xs font-bold px-5 py-2.5 rounded-full transition-all flex items-center gap-1.5 shadow-sm"
                  >
