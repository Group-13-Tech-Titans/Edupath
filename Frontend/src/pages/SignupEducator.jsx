...
const SignupEducator = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!form.credentialsLink)
      newErrors.credentialsLink = "Specialization required";
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-2xl border border-black/10 bg-white/70 px-3 py-2 text-sm outline-none ring-primary/40 focus:ring"
            />
            {errors.specializationTag && (
              <p className="text-red-500 text-xs">{errors.specializationTag}</p>
            )}
          </div>
          <div>
            <label className="text-xs font-medium">
            ...
            <input
              ...
              className="mt-1 w-full rounded-2xl border border-black/10 bg-white/70 px-3 py-2 text-sm outline-none ring-primary/40 focus:ring"
            />
            {errors.credentialsLink && (
              <p className="text-red-500 text-xs">{errors.credentialsLink}</p>
            )}
          </div>
          {error && (
