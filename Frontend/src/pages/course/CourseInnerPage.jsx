...
import { buildDownloadUrl } from "../../api/uploadApi.js";
                ...
                {normalizeType(activeItem?.type) === "Video" && activeItem?.url ? (
                  ...
                  <div className="grid min-h-[320px] place-items-center rounded-2xl bg-black/5">
                    <div className="text-center px-6">
                      ...
                      {activeItem?.url && (
                        <a
                          href={buildDownloadUrl(activeItem.url, activeItem.name, activeItem.format)}
                          target="_blank"
                          rel="noreferrer"
                          download={activeItem.format ? `${activeItem.name}.${activeItem.format}` : undefined}
                    ...
                    {materials.map((m, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {m.url && (
                            <a
                              href={buildDownloadUrl(m.url, m.name || m.title, m.format)}
                              target="_blank"
                              rel="noreferrer"
                              download={m.format ? `${m.name || m.title || "file"}.${m.format}` : undefined}
