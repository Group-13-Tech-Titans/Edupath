...
// ==========================================
// MAIN COMPONENT: ADMIN PATHWAY EDIT
// ==========================================
    ...
    const fetchTemplateAndSpecializations = async () => {
      ...
      try {
        ...
        try {
          ...
          console.error("Could not load spec DB", e);
          setError("Warning: Could not load specializations list.");
        } finally {
      ...
      <div className="mx-auto max-w-4xl space-y-6 pb-12">
        ...
        <div className="rounded-[28px] border border-black/5 bg-white/70 p-6 shadow-sm backdrop-blur">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              <label htmlFor="pathNameSelect" className="mb-1 block text-sm font-medium text-text-dark">Pathway Name (Specialization)</label>
              <select
                id="pathNameSelect"
                name="pathName"
            ...
            return (
              <div key={stepIdentifier} className="relative rounded-[22px] border border-black/5 bg-white/80 p-5 shadow-sm">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  ...
                  {/* PLATFORM COURSES (S2004 Resolved by Sub-Component) */}
