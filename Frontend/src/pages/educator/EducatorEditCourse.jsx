            ...
            <div className="mt-5 space-y-4 text-xs">
              ...
              <div className="rounded-2xl border border-emerald-200 bg-emerald-50/60 p-4">
                ...
                <p className="text-[11px] text-emerald-700 leading-relaxed">
                  EduPath courses are completely free for enrolled students. You earn <strong>$1.00 USD</strong> per student enrollment, withdrawable during the <strong>first week of every month (Days 1–7)</strong>.
                </p>
              </div>
