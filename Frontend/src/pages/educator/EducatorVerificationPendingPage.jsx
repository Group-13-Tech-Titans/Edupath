      ...
      <div className="flex min-h-[calc(100vh)] items-center justify-center bg-gradient-to-b from-emerald-200 via-teal-200 to-cyan-200 px-4 py-10">
        <div className="w-full max-w-xl rounded-[32px] bg-white/85 p-8 shadow-2xl shadow-emerald-300/50 backdrop-blur">
          {isRejected ? (
            <>
              {/* Rejected Icon */}
              <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-b from-rose-200 to-red-200 shadow-md">
              ...
              <div className="mt-6 text-center">
                ...
                <p className="mx-auto mt-2 max-w-md text-sm text-slate-500">
                  Unfortunately, your educator application was not approved at this time. Please review your credentials and submit again.
                </p>
              </div>
              ...
              <div className="mt-6 rounded-2xl border border-rose-100 bg-rose-50/70 p-4">
                <div className="flex items-start gap-3">
                  <span className="mt-1 inline-flex h-3 w-3 rounded-full bg-rose-400 ring-4 ring-rose-200" />
                  <div className="flex-1">
                    <p className="text-sm font-semibold text-slate-900">
                      Status: Rejected
                    </p>
                    <p className="mt-1 text-sm text-slate-500">
                      You can re-apply by updating your information and providing valid credentials.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-col gap-3">
                <button
                  ...
                  className="w-full rounded-full bg-rose-400 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-rose-300/40 transition hover:bg-rose-500 active:scale-[0.99]"
                >
                  Request Verification Again
                </button>
                <button
                  onClick={() => navigate("/login")}
                  className="w-full rounded-full bg-slate-200 px-6 py-3 text-sm font-semibold text-slate-700 transition hover:bg-slate-300 active:scale-[0.99]"
                >
                  Back to Login
                </button>
              </div>
