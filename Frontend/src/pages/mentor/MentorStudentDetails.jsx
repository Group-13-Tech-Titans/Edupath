        ...
        <aside className="lg:col-span-1">
          <div className="rounded-3xl bg-white p-8 shadow-[0_4px_20px_rgba(0,0,0,0.08)]">
            <div className="mb-6 flex flex-col items-center text-center">
              ...
              <span className={`mt-2 inline-flex rounded-full px-3 py-1 text-[10px] font-black uppercase tracking-wider ${
                student.isPremium || student.subscription?.plan === "premium"
                  ? "bg-emerald-500 text-white"
                  : "bg-slate-100 text-slate-600"
              }`}>
                {student.isPremium || student.subscription?.plan === "premium" ? "✨ Premium Member" : "Free Plan"}
              </span>
