...
function toSafeUser(user, subscriptionStatus) {
  ...
  // Build a clean, explicit subscription object that matches authController.toSafeUser output.
  // This guarantees isPremium is a reliable boolean that all frontend checks can trust.
  const storedSub = safeUser.subscription && typeof safeUser.subscription === "object" ? safeUser.subscription : {};
